...
const Welcome = () => (
  <Row justify="center">
    ...
    <div style={{ marginTop: 20, marginLeft: 'auto' }}>
      <a href="https://kr.freepik.com/free-vector/happy-tiny-people-near-huge-welcome-word-flat-illustration_11235579.htm#page=2&query=welcome&position=38&from_view=search&track=sph&uuid=6287d2e5-782a-4493-9732-1435f02ee2c0">
        작가 pch.vector
      </a>{' '}
      출처 Freepik
    </div>
