...
import { changePw, loadUserInfoData, updateUser, uploadFile } from '@/src/app/api/Api';
import { ChangeDataTypes, UserInfoTypes } from '@/src/types/User/User.interface';
import { FileTypes } from '@/src/types/Common/Common.interface';
