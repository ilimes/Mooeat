            ...
            <>
              ...
              {!session && (
                <>
                  ...
                  <div
                    style={{ width: 100, textAlign: "center", marginLeft: 10 }}
                  >
                    <StyledButton
                      type="primary"
  ...
  return (
    <StyledAlertCol span={24}>
      <div style={{ display: "flex", gap: 10 }}>
        ...
        <div>
          <StyledOutDiv style={{ fontSize: 14 }}>
            <Point>LIME</Point>님이 회원님의 글에 <Point>좋아요</Point>를
            눌렀습니다.
          </StyledOutDiv>
          <StyledOutDiv style={{ fontSize: 13, color: "grey" }}>
            2분 전
    ...
    <Col span={24}>
      <div style={{ display: "flex", gap: 10 }}>
        ...
        <div>
          ...
          <Button
            type="primary"
            style={{ fontSize: 13, margin: "7px 7px 0 0" }}
          >
            수락
          </Button>
