...
const CarouselComponent = () => {
    ...
    const links = ['/test', '/auth/join', '/test2'];
                ...
                <div onClick={() => router.push(links?.[nowIndex])}>
                  ...
                  >
                    <Col span={12} style={{ padding: 16, marginTop: 100 }}>
                      <span
                        style={{
                          ...
                          fontSize: 24,
                          background:
                            "linear-gradient(to top, #323232 45%, transparent 50%)",
                        }}
                      >
                        Mooeat에 오신것을 환영합니다!
                      </span>
                    ...
                    <Col span={12} style={{ overflow: "hidden" }}>
                      ...
                      <Lottie animationData={animationData} loop={true} style={{ width: 340, height: 380, margin: '0 auto' }} />
                    </Col>
                  </Row>
                </div>
                <div onClick={() => router.push(links?.[nowIndex])}>
                    ...
                    <Col span={11} style={{ padding: 16, marginTop: 100 }}>
                      <span
                        style={{
                          ...
                          fontSize: 24,
                          background:
                            "linear-gradient(to top, #D98B35 45%, transparent 50%)",
                        }}
                      >
                        지금 바로 가입해보세요!
                      </span>
                    ...
                    <Col span={11} style={{ padding: 16, marginTop: 100 }}>
                      <span
                        style={{
                          ...
                          fontSize: 24,
                          background:
                            "linear-gradient(to top, grey 45%, transparent 50%)",
                        }}
                      >
                        3번쨰 캐러샐 입니다
                      </span>
